...
![Preliminary results showing how the uncertainty around partitioned variance decreses with sample size](https://github.com/ManueleBazzichetto/BootVarParty/blob/main/BootVar_prel_res.jpeg)
